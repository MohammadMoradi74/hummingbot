...
class BitpinUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.auth = BitpinAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
        ...
        self.data_source = BitpinAPIUserStreamDataSource(
            auth=self.auth,
    ...
    @patch("hummingbot.connector.exchange.bitpin.bitpin_api_user_stream_data_source.BitpinAPIUserStreamDataSource"
           "._ping_listen_key",
