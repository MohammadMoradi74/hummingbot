...
class NobitexUtilTestCases(unittest.IsolatedAsyncioTestCase):
    ...
    def test_public_rest_url(self):
        ...
        self.assertEqual("https://apiv2.nobitex.ir/v3/TEST_PATH", web_utils.public_rest_url(path_url, domain))

    def test_private_rest_url(self):
        path_url = "/TEST_PATH"
        domain = "ir"
        self.assertEqual(
            "https://apiv2.nobitex.ir/TEST_PATH",
            web_utils.private_rest_url(path_url, domain),
        )
